...
- Note that our Tensorflow implementation can be tuned to leverage different filters of different `n × 3` shapes. We set `n` to `1` in our paper for simplification.
